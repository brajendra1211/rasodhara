    ...
    <>
      {open && (
        <div
          ...
          className="fixed bottom-36 right-4 z-50 flex h-[70vh] max-h-[520px] w-[calc(100vw-2rem)] max-w-sm flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl sm:bottom-24 dark:border-zinc-800 dark:bg-zinc-950"
        >
              ...
              <div
                ...
                className={`max-w-[85%] whitespace-pre-line rounded-2xl px-3 py-2 text-sm ${
                  m.role === "user"
                    ...
                    : "self-start bg-zinc-100 text-zinc-800 dark:bg-zinc-900 dark:text-zinc-100"
                }`}
              >
                {m.content}
              </div>
